  ...
  overridableMkRustCrate = f:
    let
      drvs = genDrvsByProfile profilesByName ({ profile, profileName }: mkRustCrate ({
          inherit release profile hostPlatformCpu hostPlatformFeatures target profileOpts codegenOpts cargoUnstableFlags;
	  rustcLinkFlags = (builtins.map (f: "--cfg ${f}") cfgFlags) ++ rustcLinkFlags;
	  rustcBuildFlags = (builtins.map (f: "--cfg ${f}") cfgFlags) ++ rustcBuildFlags;
      } // (f profileName)));
...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustix."0.38.19" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      bitflags = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."2.4.1" { inherit profileName; }).out;
      ${ if !(builtins.elem "rustix_use_libc" cfgFlags) && !(builtins.elem "miri" cfgFlags) && hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64) || !hostPlatform.isWindows && (builtins.elem "rustix_use_libc" cfgFlags || builtins.elem "miri" cfgFlags || !(hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64))) || hostPlatform.isWindows then "libc_errno" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".errno."0.3.5" { inherit profileName; }).out;
      ${ if !(builtins.elem "rustix_use_libc" cfgFlags) && !(builtins.elem "miri" cfgFlags) && hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64) || !hostPlatform.isWindows && (builtins.elem "rustix_use_libc" cfgFlags || builtins.elem "miri" cfgFlags || !(hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64))) then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.149" { inherit profileName; }).out;
      ${ if !(builtins.elem "rustix_use_libc" cfgFlags) && !(builtins.elem "miri" cfgFlags) && hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64) || (hostPlatform.parsed.kernel.name == "android" || hostPlatform.parsed.kernel.name == "linux") && (builtins.elem "rustix_use_libc" cfgFlags || builtins.elem "miri" cfgFlags || !(hostPlatform.parsed.kernel.name == "linux" && hostPlatform.parsed.cpu.significantByte == "littleEndian" && (hostPlatform.parsed.cpu.name == "armv6l" || hostPlatform.parsed.cpu.name == "armv7l" || hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.cpu.bits == 64 || hostPlatform.parsed.cpu.name == "riscv64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "powerpc64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips32r6" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64" || builtins.elem "rustix_use_experimental_asm" cfgFlags && hostPlatform.parsed.cpu.name == "mips64r6" || hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.cpu.bits == 64))) then "linux_raw_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".linux-raw-sys."0.4.10" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "windows_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.48.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".windows-targets."0.48.5" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.parsed.cpu.name == "aarch64" && hostPlatform.parsed.abi.name == "msvc" && !(builtins.elem "windows_raw_dylib" cfgFlags) then "windows_aarch64_msvc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows_aarch64_msvc."0.48.5" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "i686" && hostPlatform.parsed.abi.name == "gnu" && !(builtins.elem "windows_raw_dylib" cfgFlags) then "windows_i686_gnu" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows_i686_gnu."0.48.5" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "i686" && hostPlatform.parsed.abi.name == "msvc" && !(builtins.elem "windows_raw_dylib" cfgFlags) then "windows_i686_msvc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows_i686_msvc."0.48.5" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.abi.name == "gnu" && !(builtins.elem "windows_raw_dylib" cfgFlags) then "windows_x86_64_gnu" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows_x86_64_gnu."0.48.5" { inherit profileName; }).out;
      ...
      ${ if hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.abi.name == "msvc" && !(builtins.elem "windows_raw_dylib" cfgFlags) then "windows_x86_64_msvc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows_x86_64_msvc."0.48.5" { inherit profileName; }).out;
    };
  });
